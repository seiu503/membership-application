...
<div id="memberapp">
 ...
 Please complete this form to recommit to your fellow SEIU 503 members that you will stand united with them in the face of attacks against our union. By doing so, you will commit to sustaining the work we accomplish together by maintaining your membership for one year, or paying a non-member fee equivalent.</p>
<p class="instructions">
By standing in union with your co-workers, you are helping to build our union strength and showing wealthy special interests that we won't back down in the face of their attacks. <strong>We truly are stronger together!</strong></p>
...
<hr>
 ...
 <p class="small">Your full name, the network address you are accessing this page from, and the timestamp of submission will serve as signature indicating: I hereby designate SEIU Local 503, OPEU (or any successor Union entity) as my desired collective bargaining agent. I also hereby authorize my employer to deduct from my wages, commencing with the next payroll period, all Union dues and other fees or assessments as shall be certified by SEIU Local 503, OPEU (or any successor Union entity) and to remit those amounts to such Union. This authorization/delegation is unconditional, made in consideration for the cost of representation and other actions in my behalf by the Union and is made irrespective of my membership in the Union. This authorization is irrevocable for a period of one year from the date of execution and from year to year thereafter unless not less than thirty (30) and not more than forty-five (45) days prior to the end of any annual period or the termination of the contract between my employer and the Union, whichever occurs first, I notify the Union and my employer in writing, with my valid signature, of my desire to revoke this authorization. <a href="#hideterms" onClick="terms()">hide terms</a></p>
  ...
  <p class="instructions">This site uses Google Analytics to collect further information about you and your usage of this and other sites and pages. This tracking is provided through the use of cookies. <a href="https://www.google.com/policies/privacy/partners/">Click here </a> for more information on Google Analytics, how this information is collected and used and how to control information sent to Google and partners. By using this site, you consent to the storing and accessing of cookies or other information on the device used to access this page.</p>
</div>
</div>
</body>
...
{
    echo "<select name=\"language\" id=\"language\" class=\"custom-dropdown__select custom-dropdown__select--white\">\n";
...
{
    echo "<select name=\"ethnicity\" id=\"ethnicity\" class=\"custom-dropdown__select custom-dropdown__select--white\">\n";
