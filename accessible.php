...
<head>
  ...
  $(function() {
	...
	$('.phone_mob').inputmask('(999) 999-9999', { showMaskOnFocus: false, showMaskOnHover: false, "oncomplete": function(){ $(".phone").show(); document.getElementById("sms").checked = true; } });
	
	$('input[type="checkbox"][name="termsagree"]').change(function() {
     if(this.checked) {
         $("#scholarshipdiv").show();
     }
...
<div id="memberapp">
  <h1>Member Signup</h1>
 <hr>
  <p class="instructions">Please complete all required fields. Required fields are indicated by a light purple background and followed by an asterisk. <a href="#optional" onClick="showFields()">Optional fields</a> used to provide more information have a white background. Submission of this form indicates an agreement to the membership terms below. Your full name, network address, and a timestamp of your submission will serve as your signature.</p>
   <div class="optional">
...
<hr>
 ...
 <span class="custom-dropdown custom-dropdown--purple">
  ...
  <div class="mobile">
	  ...
	  <div class="phone">
		<input type="checkbox" value="yes" id="sms" name="sms" />
		<label for="sms" class="checkbox">Receive mobile alerts&dagger;</label>
