...
//language -- drop, single character code -- updated to 3 character iso369-2 code on 9/1/2017
...
{
	//$errors++;
	//$errormessages .= "Invalid Residence State. State should be exactly 2 characters.<br>\n";
	//Field is optional, assume not entered or if invalid just ignore bad data
}
